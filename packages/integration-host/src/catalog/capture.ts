...
import type { ToolRecord } from "./store.ts"
import { ToolRecord as ToolRecordSchema } from "./store.ts"
...
): Effect.Effect<ToolRecord, StorageError> =>
  Schema.decodeUnknownEffect(ToolRecordSchema)({
    address: toolAddress({
