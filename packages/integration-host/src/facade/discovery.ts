import type { CatalogApi } from "./api.ts"
import type { IntegrationInspection } from "@mokronos/contracts"
import type { EndpointDetection } from "@mokronos/contracts"
...
const confidenceRank = (confidence: EndpointDetection["confidence"]): number => {
  switch (confidence) {
    case "high": return 3
...
const bestDetection = (
  detections: ReadonlyArray<EndpointDetection>
): EndpointDetection | undefined =>
  detections
