import { connectionOwner, connectionRefOf, isDelegationTemplate, whenPresent } from "@mokronos/integrations-contracts"
import type { InvocationOutcome } from "@mokronos/integrations-contracts"
