...
} from "../src/auth-templates.ts"
import type { CompiledSecurityScheme } from "../src/openapi.ts"
import type { ExecutorMcpProbe } from "../src/schemas.ts"

const probe = (overrides: Partial<ExecutorMcpProbe>): ExecutorMcpProbe => ({
  connected: true,
