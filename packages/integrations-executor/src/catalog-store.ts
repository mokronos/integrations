...
import type { SqlRow, SqlStatement, SqlValue } from "./database.ts"
...
import { ExecutorAuthMethod, ExecutorOwner } from "./schemas.ts"
import { IntegrationKind } from "./integration-model.ts"
...
export const ConnectionRecord = Schema.Struct({
  ...
  oauthClientOwner: Schema.optional(ExecutorOwner),
...
const decodeAuthMethods = decodeJsonArray(ExecutorAuthMethod)
...
>()("@mokronos/integrations-executor/CatalogStore") {
