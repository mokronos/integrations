...
import { d1ExecutorStorage } from "./executor-d1.ts"
 ...
 *  this deployment hangs off: gateway payload sealing and Executor credential
...
const getService = (env: Env): Promise<GatewayService> => {
  servicePromise ??= (async () => {
    ...
    return await createGatewayService({
      ...
      executorStorage: d1ExecutorStorage(database, key),
